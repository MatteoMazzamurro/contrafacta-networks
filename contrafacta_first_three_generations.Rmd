...
Contrafacta creation date are selected uniformly at random within the interval provided in the BdT. The operation is repeated 100 times and results are compared with the deterministic selection.
```{r}
